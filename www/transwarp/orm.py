...
'''
Database operation module, this module is indepent with web module.
'''
...
class StringField(Field):
	"""String type Field, base on Field class"""
	def __init__(self, **kw):
...
class IntegerField(Field):
	"""Integer type Field, base on Field class"""
	def __init__(self, **kw):
		if not 'default' in kw:
			kw['default'] = 0
		if not 'ddl' in kw:
...
class TextField(Field):
	"""Text type Field, base on Field class"""
	def __init__(self, **kw):
		if not 'default' in kw:
			kw['default'] = ''
		if not 'ddl' in kw:
...
class BlobField(Field):
	"""Blob type Field, base on Field class"""
	def __init__(self, **kw):
		if not 'default' in kw:
			kw['default'] = ''
		if not 'ddl' in kw:
